/**
 * Input Validation for Guest Payment Records Edge Function
 * Split Lease - Supabase Edge Functions
 */

import { ValidationError } from '../../_shared/errors.ts';
import { GenerateGuestPaymentRecordsInput, RentalType, WeekPattern } from './types.ts';
...
/**
 * Validate input for generating guest payment records
 */
export function validateGenerateInput(input: Partial<GenerateGuestPaymentRecordsInput>): void {
