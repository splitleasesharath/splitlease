...
# =============================================================================
TEST_IDS = {
    # Listing IDs - Use real IDs from Supabase
    "listing_id": "clv7k2x0g0001qw0g8h3j4k5l",  # TODO: Replace with actual test listing

    # User IDs - Use real IDs from Supabase
    "user_id_host": "auth-host-uuid-here",  # TODO: Replace with actual host user
    "user_id_guest": "auth-guest-uuid-here",  # TODO: Replace with actual guest user

    # Proposal IDs
    "proposal_id": "prop-uuid-here",  # TODO: Replace with actual proposal

    # Help Center Categories
    "help_center_category": "guests",  # Known category
}
