...
7. **Add "Affected Pages:" field with specific URLs or "N/A"**
8. **Add testing checklist for each chunk**
9. **Keep chunks independent (fixable in any order)**

**ABSOLUTELY CRITICAL - CODE BLOCK REQUIREMENT:**
Every single chunk MUST contain:
- First code block (Current Code) - full code snippet
...
- Both code blocks must use ```javascript or ```typescript fences
"""
