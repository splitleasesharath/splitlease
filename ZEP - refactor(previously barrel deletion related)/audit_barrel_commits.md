...
```
Read the instructions in refactor/audit_barrel_commits.md and execute the audit
```
...
if [ -f "refactor/detect_barrel_files.py" ]; then
    uv run refactor/detect_barrel_files.py app/src --min-reexports 2 2>/dev/null | head -30
else
