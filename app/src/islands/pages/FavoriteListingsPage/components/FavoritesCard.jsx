...
const FavoritesCard = ({
  ...
  return (
    <article className="favorites-card" onClick={handleCardClick}>
      ...
      {/* Content Section - INLINE STYLES to guarantee override */}
      <div className="favorites-card__content" style={{ padding: '6px 8px 8px', boxSizing: 'border-box' }}>
        {/* Location */}
        <div className="favorites-card__location" style={{ margin: 0 }}>
